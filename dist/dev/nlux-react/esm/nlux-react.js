import { useEffect, useRef, useMemo, useState, useImperativeHandle, useCallback, Component, isValidElement, forwardRef, createRef, createContext, useReducer, useContext, lazy, Suspense } from 'react';
...
const AvatarComp = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: className$6, children: [
...
const GreetingContainer = ({ children }) => {
  return /* @__PURE__ */ jsx("div", { className: className$3, children });
};
...
const LoaderComp = () => {
  return /* @__PURE__ */ jsx("div", { className: className$2, children: /* @__PURE__ */ jsx("div", { className: "nlux-comp-loaderContainer", children: /* @__PURE__ */ jsx("span", { className: "spinning-loader" }) }) });
};
...
const CancelIconComp = () => {
  return /* @__PURE__ */ jsx("div", { className: className$1, children: /* @__PURE__ */ jsx("div", { className: "nlux-comp-cancelIcon-container" }) });
};

const className = "nlux-comp-sendIcon";

const SendIconComp = () => {
  return /* @__PURE__ */ jsx("div", { className: className, children: /* @__PURE__ */ jsx("div", { className: "nlux-comp-sendIcon-container" }) });
};
...
const RemixComposerComp = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${className} w-100`, id: "inner-composer-container", children: [
    promptState.selectContext && /* @__PURE__ */ jsxs("div", { className: "d-flex flex-column border w-100 px-3 pt-3 align-items-start justify-content-center align-self-start", children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "list-unstyled", children: [
        ...
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("div", { className: "d-flex ml-2 custom-control custom-radio", children: [
          ...
          /* @__PURE__ */ jsx("label", { className: "form-check-label custom-control-label", htmlFor: "workspace", "data-id": "workspace-context-option", children: "Workspace" })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { id: "composer-textarea-holder", className: "bg-light d-flex flex-column w-100 p-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-3 w-100", children: [
        ...
        /* @__PURE__ */ jsxs("div", { id: "composer-buttons", className: "d-none", children: [
      ...
      /* @__PURE__ */ jsx(RenderIf, { condition: promptState.files.length > 0, children: /* @__PURE__ */ jsxs("div", { id: "context-holder", className: "d-flex gap-2 text-white justify-content-start align-items-center flex-wrap text-success py-3 border-warning overflow-y-scroll", children: [
        Array.isArray(promptState.files) ? promptState.files.slice(0, 4).map((file, index) => {
          return /* @__PURE__ */ jsxs("span", { className: "badge badge-info text-success p-1 rounded m-1 text-truncate", children: [
            file,
            " ",
            /* @__PURE__ */ jsx("i", { className: "fas fa-times", style: { cursor: "pointer" }, onClick: () => removeFile(file) })
          ] }, index);
        }) : /* @__PURE__ */ jsxs("span", { className: "badge badge-info text-success p-1 rounded m-1", onClick: () => removeFile(promptState.files), children: [
          promptState.files,
          " ",
          /* @__PURE__ */ jsx("i", { className: "fas fa-times", style: { cursor: "pointer" }, onClick: () => removeFile(promptState.files) })
        ] }),
        /* @__PURE__ */ jsx(RenderIf, { condition: promptState.files.length > 4 && promptState.files !== "@workspace", children: /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("span", { className: "badge badge-info text-success p-1 rounded m-1", children: [
            promptState.files.length - 4,
            " more file",
            promptState.files.length - 4 > 1 ? "s" : ""
          ] }),
          /* @__PURE__ */ jsxs("span", { style: { cursor: "pointer" }, className: "badge badge-info text-success p-1 rounded m-1", onClick: () => removeAllFiles(), children: [
            "Remove all ",
...
const AiChat = function(props) {
  ...
  return /* @__PURE__ */ jsx(PrimitivesContextProvider, { children: /* @__PURE__ */ jsxs("div", { className: rootClassNames, style: rootStyle, "data-color-scheme": colorSchemeToApply, children: [
    /* @__PURE__ */ jsx("div", { className: className$7, ref: exceptionBoxRef }),
    /* @__PURE__ */ jsxs("div", { className: `nlux-chatRoom-container ${compChatRoomStatusClassName}`, children: [
      ...
      /* @__PURE__ */ jsx("div", { id: "remix-composer-container", className: "nlux-composer-container", children: uiOverrides.Composer ? uiOverrides.Composer : /* @__PURE__ */ jsx(
        RemixComposerComp,
        {
