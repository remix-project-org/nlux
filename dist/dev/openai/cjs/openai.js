...
const VERSION = '4.100.0'; // x-release-please-version
...
class OpenAiAbstractAdapter {
  constructor({
    ...
    this.systemMessage = "Act as a helpful assistant to the user";
...
class OpenAiAdapterBuilderImpl {
  constructor(cloneFrom) {
    this.apiKey = null;
    this.dataTransferMode = defaultDataTransferMode;
    this.model = null;
    this.systemMessage = null;
    this.withApiKeyCalled = false;
    this.withDataTransferModeCalled = false;
    this.withModelCalled = false;
    this.withSystemMessageCalled = false;
    if (cloneFrom) {
