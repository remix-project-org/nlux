(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('stream'), require('http2'), require('url'), require('buffer'), require('http'), require('fs/promises'), require('fs'), require('crypto'), require('path'), require('child_process'), require('util'), require('os'), require('process'), require('https')) :
    typeof define === 'function' && define.amd ? define(['exports', 'stream', 'http2', 'url', 'buffer', 'http', 'fs/promises', 'fs', 'crypto', 'path', 'child_process', 'util', 'os', 'process', 'https'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@nlux/bedrock"] = {}, global.stream, global.http2, global.url, global.buffer, global.http, global.fs$1, global.fs, global.crypto$1, global.path, global.child_process, global.util$4, global.os, global.process$1, global.https));
})(this, (function (exports, stream, http2, url, buffer, http, fs$1, fs, crypto$1, path, child_process, util$4, os, process$1, https) { 'use strict';
...
${toHex(hashedRequest)}`;
    ...
    const getHomeDir$1 = () => {
        ...
        if (!homeDirCache$1[homeDirCacheKey])
            homeDirCache$1[homeDirCacheKey] = os.homedir();
    ...
    const getConfigFilepath$1 = () => process.env[ENV_CONFIG_PATH$1] || path.join(getHomeDir$1(), ".aws", "config");

    const ENV_CREDENTIALS_PATH$1 = "AWS_SHARED_CREDENTIALS_FILE";
    const getCredentialsFilepath$1 = () => process.env[ENV_CREDENTIALS_PATH$1] || path.join(getHomeDir$1(), ".aws", "credentials");
    ...
    var homepage$2 = "https://github.com/aws/aws-sdk-js-v3/tree/main/clients/client-bedrock-runtime";
    var repository$2 = {
    	type: "git",
...
or increase socketAcquisitionWarningTimeout=(millis) in the NodeHttpHandler config.`);
    ...
    _BedrockChatAdapterImpl.defaultDataTransferMode = "batch";
